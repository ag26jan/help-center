...
/**
 * Render the homepage UI with a searchable list of articles, category cards, and a theme toggle.
 *
 * The component maintains a search query, filters articles by title, displays matching article links
 * when a query is present, and otherwise shows category cards with article counts. Includes header
 * with logo and theme toggle, and a footer with navigation and social links.
 *
 * @returns {JSX.Element} The homepage React element containing search, results or categories, and footer.
 *
